...
<div class="container"  style="max-width:1000px; margin-top: 50px; height:800px" >
<!-- 상단 컨텐츠 시작 -->
	...
	<!-- 아이디찾기 Sidebar 시작 -->
		<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left w3-light" style="display:none; z-index:2; width:240%; min-width:300px" id="sidebarId">
		   <div class="container" style="float:left; color:white; background-color:#00579c; max-width:492px; height:700px"> 
			  ...
			  <a class="navbar-brand" href="index.html" style="margin-left:29px"><img src="<%= ctxPath%>/images/logo2.jpg" alt="IKEA_logo" width="87" height="36"/></a>			  
