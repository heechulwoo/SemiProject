...
<script type="text/javascript" src="<%= ctxPath%>/jquery-ui-1.11.4.custom_kgh/jquery-ui.js"></script>


<link rel="stylesheet" href="<%= ctxPath%>/css/style.css">
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/jquery-ui-1.11.4.custom_kgh/jquery-ui.css" />
