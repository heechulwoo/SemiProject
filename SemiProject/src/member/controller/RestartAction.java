	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		*/
		...
		if("POST".equalsIgnoreCase(method)) {
			...
			boolean isUserRestart = mdao.isUserRestart(paraMap);
			...
			if(isUserRestart) {
				...
				//	System.out.println("~~~~ 확인용 certificationCode => " + certificationCode);
					...
					GoogleMail_jy mail = new GoogleMail_jy();
					
					try {
						mail.sendmail(email, certificationCode);  // 메일을 보내는것
			 	...
			 	request.setAttribute("isUserRestart", isUserRestart);
