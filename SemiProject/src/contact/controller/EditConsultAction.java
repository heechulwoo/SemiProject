...
public class EditConsultAction extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(loginuser != null ) {
			...
			if( loginuser.getUserid().equals(fk_userid) ) {
				...
				if(Cfile.exists()){
					...
					super.setViewPage("/WEB-INF/contact/editConsult.jsp"); // 수정 페이지로 넘어감 EditConsult
		...
		*/		
			...
			String message = "문의글을 수정 하기 전에 먼저 로그인을 해주세요!";
